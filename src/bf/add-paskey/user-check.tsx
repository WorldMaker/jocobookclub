...
export function UserCheck({ backedup, multiDevice }: UserCheckProps) {
  return <div class='notification is-warning'>
    ...
    {multiDevice ? '' : ' The Passkey claims it is not available for multi-device use.'}
    You may want to <a href="../passkey">add another Passkey</a> that is.
    Otherwise, <a href="../">check out the current ballot</a>.
  </div>
}
