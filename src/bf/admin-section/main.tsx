...
function AdminSection(
  ...
  return (
    <section class='section'>
      ...
      <p class='block'>
        <strong>Reminder:</strong> When posting to Facebook you should remind
        people to find the "Open in External Browser" option in the menu to be
        able to reliably register using the invite link.
      </p>
      <p class='block'>
