...
export async function buildSuggestionStamps(document: Document) {
  // paths are relative to the project root
  await Deno.mkdir('../site/_includes/bf', { recursive: true })
  await Deno.writeTextFile('../site/_includes/bf/suggestions-page.html', '', {
    create: true,
  })
  ...
  await Deno.writeTextFile(
    '../site/_includes/bf/suggestions-page.html',
